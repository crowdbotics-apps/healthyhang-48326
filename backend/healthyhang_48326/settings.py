"""
Django settings for healthyhang_48326 project.
...
ROOT_URLCONF = 'healthyhang_48326.urls'
...
WSGI_APPLICATION = 'healthyhang_48326.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthyhang_48326 API",
    "DESCRIPTION": "API documentation for healthyhang_48326 App",
    "VERSION": "v1",
}
